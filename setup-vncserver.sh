...
apt update && apt install -y wget libglu1-mesa-dev mesa-utils xterm xauth x11-xkb-utils xfonts-base xkb-data libxtst6 libxv1 icewm gsettings-desktop-schemas
